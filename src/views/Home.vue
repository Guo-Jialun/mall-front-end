        ...
        <div>
          ...
          >
            ...
            <div style="float: right">
              ...
              <div v-show="!this.hasToken" style="display: inline-block;">
                <el-menu-item index="/login" class="menu-item" @click="routerLink('/login')">登录</el-menu-item>
                <el-menu-item index="/register" class="menu-item" @click="routerLink('/register')">注册</el-menu-item>
              </div>
            </div>
          </el-menu>
        </div>
